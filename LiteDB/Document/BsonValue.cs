    ...
    public class BsonValue : IComparable<BsonValue>, IEquatable<BsonValue>
    {
        ...
        public virtual int CalcByteCount()
        {
            switch (Type)
            {
                ...
                case BsonType.Document: return AsDocument.CalcByteCount();
                case BsonType.Array: return AsArray.CalcByteCount();
            }
        ...
        /// </summary>
        protected int CalcByteCountElement(string key, BsonValue value)
        {
